...
(() => {
  ...
  const DRILLS = {
    ...
    pressure: { title: "仍承压 · 12 个行业", value: "12 / 31",
      sub: "盈利承压与出清中段行业:家电、房地产、商贸零售、建筑装饰等;双低(营收低、股价低)为主。", source: "K33 · industry_master.csv(2026-08-07)" },
    near: { title: "临近上升 · 9 个行业", value: "9 / 31",
      sub: "底部观察区:农林牧渔(猪)、食品饮料(白酒)、汽车、光伏子链等——仅有政策底或单证据族信号。", source: "K33 · industry_master.csv(2026-08-07)" },
    up: { title: "上升象限 · 10 个行业", value: "10 / 31",
      sub: "双证据族确认:电子、通信(光模块/CPO)、电新(锂电/储能);确认/暂定偏确认:军工、非银、机械、计算机、传媒、医药。", source: "K33 · industry_master.csv(2026-08-07)" },
